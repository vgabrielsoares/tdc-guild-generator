...
describe('MultiRollHandler - Helper Functions', () => {
  ...
  describe('createBooleanBasedRollAgainChecker', () => {
    it('deve detectar propriedade boolean true', () => {
      const checker = createBooleanBasedRollAgainChecker<{rollTwice: boolean}>('rollTwice');
    ...
    it('deve funcionar com valores truthy/falsy', () => {
      const checker = createBooleanBasedRollAgainChecker<{count: number}>('count');
    ...
    it('deve funcionar com strings', () => {
      const checker = createBooleanBasedRollAgainChecker<{status: string}>('status');
