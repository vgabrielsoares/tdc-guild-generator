<template>
  <div
    class="guild-relations bg-gray-800 rounded-lg shadow-md p-6 border border-gray-700"
  >
    <div class="flex items-center justify-between mb-4">
      ...
      >
        ...
        >
          <InfoButton
            help-key="guild-relations"
            @open-help="$emit('open-help', 'guild-relations')"
          />
        </Tooltip>
      </h3>
      <Tooltip
    ...
    <div class="space-y-4">
      ...
      <div class="bg-gray-700 rounded-lg p-4 border border-gray-600">
        <h4
          class="font-semibold text-gray-300 mb-2 flex items-center space-x-2"
        >
        ...
        <div class="flex items-center space-x-2">
          <span
            ...
            :class="getRelationCircleColor(guild.relations.government)"
          ></span>
        ...
        <div v-if="guild.relations.governmentDescription" class="mt-2">
          <p class="text-gray-300 text-sm italic">
            {{ guild.relations.governmentDescription }}
          </p>
        </div>
        ...
        <div class="mt-2 text-xs text-blue-200">
          ...
          <span
            :class="
              getModifierColor(getRelationModifier(guild.relations.government))
            "
          >
            {{
      ...
      <div class="bg-gray-700 rounded-lg p-4 border border-gray-600">
        ...
        >
          ...
          <Tooltip
            content="Como cidadãos comuns veem a Guilda. Afeta cooperação, informações disponíveis e recursos."
        ...
        <div class="flex items-center space-x-2">
          <span
            class="inline-block w-3 h-3 rounded-full"
            :class="getRelationCircleColor(guild.relations.population)"
          ></span>
          <span class="text-white font-medium">{{
        ...
        <div v-if="guild.relations.populationDescription" class="mt-2">
          <p class="text-gray-300 text-sm italic">
            {{ guild.relations.populationDescription }}
          </p>
        </div>
        ...
        <div class="mt-2 text-xs text-blue-200">
          ...
          <span
            :class="
              getModifierColor(getRelationModifier(guild.relations.population))
            "
          >
            {{
      ...
      <div class="bg-gray-700 rounded-lg p-4 border border-gray-600">
        ...
        >
          ...
          >
            <InfoButton
              ...
              @open-help="$emit('open-help', 'guild-resources')"
              button-class="text-xs"
            />
          </Tooltip>
        </h4>
        <div class="flex items-center space-x-2">
          <span
            class="inline-block w-3 h-3 rounded-full"
            :class="getResourceCircleColor(guild.resources.level)"
          ></span>
          <span class="text-white font-medium">{{
        ...
        <div class="mt-3 p-3 bg-gray-600 rounded border border-gray-500">
          <div class="text-xs text-gray-300 mb-2 font-medium">
          ...
          <div class="grid grid-cols-2 gap-2 text-xs">
            <div class="flex justify-between">
              ...
              <span
                :class="
                  getModifierColor(
                    getRelationModifier(guild.relations.government)
                  )
                "
              >
                {{
        ...
        <div
          v-if="guild.resources.details && guild.resources.details.length > 0"
          class="mt-2"
        >
      ...
      <div class="bg-gray-700 rounded-lg p-4 border border-gray-600">
        <div class="flex items-center justify-between mb-2">
          <h4 class="font-semibold text-gray-300 flex items-center space-x-2">
            ...
            >
              <InfoButton
                help-key="guild-visitors"
                @open-help="$emit('open-help', 'guild-visitors')"
                button-class="text-xs"
              />
            </Tooltip>
          </h4>
        ...
        <div class="flex items-center space-x-2">
          <span
            class="inline-block w-3 h-3 rounded-full"
            :class="getVisitorFrequencyCircleColor(guild.visitors.frequency)"
          ></span>
          <span class="text-white font-medium">{{
        ...
        <div
          v-if="guild.visitors.types && guild.visitors.types.length > 0"
          class="mt-2"
        >
        ...
        <p v-if="guild.visitors.description" class="text-gray-300 text-sm mt-2">
          {{ guild.visitors.description }}
        </p>
      </div>
...
import {
  getRelationCircleColor,
  getResourceCircleColor,
  getVisitorFrequencyCircleColor,
