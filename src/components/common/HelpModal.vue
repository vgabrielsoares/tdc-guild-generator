      ...
      >
        ...
        >
          ...
          >
            ...
            >
              <h3
                class="text-xl font-semibold text-amber-400 flex items-center space-x-2"
              >
            ...
            <div class="p-6 overflow-y-auto max-h-96">
              <div v-if="helpData">
                ...
                >
                  <h4
                    class="font-semibold text-amber-400 mb-2 flex items-center space-x-2"
                  >
                ...
                <!-- Exemplos -->
                <div
                  v-if="helpData.examples"
                  class="mt-6 bg-green-900 bg-opacity-20 rounded-lg p-4 border border-green-700"
                >
                  <h4
                    class="font-semibold text-green-400 mb-2 flex items-center space-x-2"
                  >
