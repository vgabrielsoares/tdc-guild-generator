  ...
  <div class="bg-gray-800 rounded-lg shadow-md p-6 border border-gray-700">
    ...
    <div class="mb-6">
      <div class="flex items-center justify-between mb-4">
        <label class="text-sm font-medium text-gray-300">Data Atual do Jogo</label>
      ...
      <!-- Status da timeline -->
      <div v-if="timelineStatus" class="p-3 rounded-lg border" 
           :class="getStatusClass(timelineStatus.status)">
        <div class="flex items-center space-x-2">
          <div class="w-2 h-2 rounded-full" 
               :class="getStatusDotClass(timelineStatus.status)"></div>
    ...
    <div class="mt-6 pt-6 border-t border-gray-700">
      <h4 class="text-md font-medium text-gray-300 mb-4">Definir Data Específica</h4>
      
      <div class="grid grid-cols-3 gap-3 mb-4">
        <div>
          <label class="block text-xs font-medium text-gray-400 mb-1">Dia</label>
          <input 
...
const timelineStatus = computed(() => {
  ...
  const nextEvent = events.value.find(e => 
