<template>
  <div class="bg-gray-800 rounded-lg shadow-md p-6 border border-gray-700">
    <div class="flex items-center justify-between mb-6">
      <h3 class="text-xl font-semibold text-white">Contratos - Timeline</h3>
      <Tooltip
    ...
    <div v-if="expiringContracts.length > 0" class="mb-6">
      <h4 class="text-lg font-medium text-white mb-3">
        Contratos Expirando em Breve (3 dias)
      </h4>
    ...
    <!-- Eventos específicos de contratos -->
    <div v-if="contractEvents.length > 0" class="mb-6">
      ...
      <div class="space-y-2">
        <div
          ...
          :key="event.id"
          class="flex items-center justify-between p-3 bg-emerald-900/30 border border-emerald-800/30 rounded-lg"
        >
