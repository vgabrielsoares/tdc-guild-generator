<template>
  <div class="bg-gray-800 rounded-lg shadow-md p-4 border border-gray-700">
    ...
    <div v-if="contractCounters" class="space-y-3">
      ...
      <div v-if="contractCounters.daysUntilNewContracts !== null" 
        ...
        <div class="flex items-center space-x-2">
          ...
          <span class="text-sm font-medium text-green-300">Novos Contratos</span>
        </div>
      ...
      <!-- Próximas resoluções -->
      <div v-if="contractCounters.daysUntilResolution !== null" 
        ...
        <div class="flex items-center space-x-2">
          ...
          <span class="text-sm font-medium text-yellow-300">Resolução Automática</span>
        </div>
      ...
      <div v-if="nextEvent" class="flex items-center justify-between p-3 bg-purple-900/30 rounded-lg border border-purple-800/30">
        <div class="flex items-center space-x-2">
    ...
    <!-- Estado sem dados -->
    <div v-if="!contractCounters && !nextEvent" 
         class="text-center py-4 text-gray-400 text-sm">
      <p>Nenhum evento agendado</p>
      <p class="text-xs mt-1 text-gray-500">Gere contratos para ver contadores</p>
    </div>
...
const canGenerateContracts = computed(() => contractsStore.canGenerateContracts);
