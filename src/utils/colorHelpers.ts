...
export const getRelationColor = (relation: string): string => {
  ...
  if (
    lowerRelation.includes("péssima") ||
    lowerRelation.includes("puro ódio")
  ) {
  ...
  if (
    lowerRelation.includes("ruim") ||
    lowerRelation.includes("mercenários") ||
    lowerRelation.includes("só causam problemas")
  ) {
  ...
  if (
    lowerRelation.includes("diplomática") ||
    lowerRelation.includes("opinião dividida") ||
    lowerRelation.includes("cordialidade")
  ) {
  ...
  // Boa - Azul
  if (
    lowerRelation.includes("boa") ||
    lowerRelation.includes("ajudam") ||
    lowerRelation.includes("mantêm seguros") ||
    lowerRelation.includes("miná-los")
  ) {
  ...
  // Muito boa - Verde
  if (
    lowerRelation.includes("muito boa") ||
    lowerRelation.includes("cooperam") ||
    lowerRelation.includes("estaríamos perdidos")
  ) {
  ...
  if (
    lowerRelation.includes("excelente") ||
    lowerRelation.includes("assentamento funcionar") ||
    lowerRelation.includes("quase como um")
  ) {
