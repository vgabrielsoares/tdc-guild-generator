<template>
  <div class="space-y-6">
    ...
    <div class="text-center">
      <h1 class="text-3xl font-medieval font-bold text-gold-400 mb-4 flex items-center justify-center gap-3">
        ...
        <Tooltip
          ...
          title="Timeline Unificada" position="auto">
          <InfoButton help-key="guild-timeline-overview" @open-help="handleOpenHelp" button-class="ml-2" />
        </Tooltip>
      </h1>
    ...
    <div v-else class="bg-red-900/30 border border-red-800/30 rounded-lg p-6 text-center">
    ...
    <template v-if="guild">
      <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div class="lg:col-span-2 space-y-6">
          <TimelineDashboard @open-help="handleOpenHelp" @generate-contracts="handleGenerateContracts" />
          <TimelineEventList @open-help="handleOpenHelp" />
        </div>

        <!-- Navegação e controles -->
        <div class="space-y-6">
          <TimelineNavigation @open-help="handleOpenHelp" @time-filter-change="handleTimeFilterChange"
