...
export const guildHelpData: Record<string, HelpData> = {
  'guild-naming': {
    ...
    description: 'Cada sede da Guilda pode ter um nome próprio para fins de identificação e personalização, mas todas fazem parte da mesma organização maior.',
    sections: [
      {
    ...
    examples: [
      {
        ...
        description: 'Guilda do Porto Dourado, Sede da Colina Verde, Bastião do Norte'
      },
      {
        title: 'Baseado em Características',
        description: 'Torre dos Sábios, Refúgio dos Mercenários, Forja dos Heróis'
      }
    ]
  },
  ...
  'guild-rules': {
    ...
    description: 'O Código de Conduta que rege o comportamento de todos os membros registrados da Guilda. Essas regras mantêm a ordem, reputação e eficiência da organização.',
    sections: [
      {
    ...
    examples: [
      {
        title: 'Dilema Moral',
        description: 'Autoridades locais ordenam prisão de refugiados inocentes. A Regra #3 prevalece sobre a #4.'
      },
      {
        title: 'Conflito Interno',
        description: 'Dois grupos de aventureiros disputam o mesmo contrato. O Conselho deve mediar e definir protocolo.'
      }
    ]
  },
  ...
  'guild-overview': {
    ...
    description: 'Um sistema completo para criar sedes da Guilda dinamicamente adaptadas aos diferentes tipos de assentamentos, desde pequenos lugarejos até grandes metrópoles.',
    sections: [
      {
    ...
    examples: [
      {
        ...
        description: 'Uma sede em débito com governo hostil pode precisar da ajuda dos jogadores para resolver situações políticas e financeiras.'
      },
      {
        title: 'Sede Próspera',
        description: 'Uma sede matriz em metrópole pode servir como base para aventuras de alto nível com acesso a recursos mágicos raros.'
      }
    ]
  },
  ...
  'guild-structure': {
    ...
    description: 'A estrutura física da Guilda varia drasticamente dependendo do assentamento onde está localizada. Desde pequenos escritórios em tavernas até complexos majestosos de múltiplos andares.',
    sections: [
      {
    ...
    examples: [
      {
        ...
        description: 'Um pequeno escritório no canto da taverna "O Javali Dourado", com apenas uma mesa e um funcionário de meio período. Ideal para aventureiros iniciantes.'
      },
      {
        title: 'Sede Matriz em Metrópole', 
        description: 'Um complexo de três andares com círculos de teletransporte, biblioteca mágica, sala de reuniões do conselho e dormitórios para membros visitantes.'
      }
    ]
  },
  ...
  'guild-relations': {
    ...
    description: 'As relações da Guilda com o governo local e a população determinam que tipos de contratos estão disponíveis e como a organização é percebida na comunidade.',
    sections: [
      {
    ...
    examples: [
      {
        ...
        description: 'Governo excelente (+3) mas população péssima (-3) = recursos normais, mas membros precisam se esconder da população hostil.'
      },
      {
        title: 'Apoio Total',
        description: 'Tanto governo quanto população amam a Guilda (+3 cada) = recursos abundantes e apoio total em missões.'
      }
    ]
  },
  ...
  'guild-staff': {
    ...
    description: 'Os funcionários são a força vital de cada sede, desde burocratas despreparados até dragões disfarçados. Cada tipo oferece diferentes capacidades e atmosfera.',
    sections: [
      {
    ...
    examples: [
      {
        ...
        description: 'Aldric sempre perde papéis importantes e confunde nomes, mas tem um coração de ouro e eventualmente resolve os problemas.'
      },
      {
        title: 'A Veterana Sábia',
        description: 'Helena, ex-sentinela aposentada, conhece todos os segredos da região e pode orientar aventureiros sobre perigos específicos.'
      }
    ]
  },
  ...
  'guild-resources': {
    ...
    description: 'Os recursos determinam que equipamentos, informações e apoio a sede pode oferecer aos seus membros. Vão desde sedes endividadas até complexos abundantemente financiados.',
    sections: [
      {
    ...
    examples: [
      {
        ...
        description: 'A sede deve 500 moedas de ouro ao Banco dos Anões. Funcionários trabalham sem salário e equipamentos estão sendo confiscados.'
      },
      {
        title: 'Sede Abundante',
        description: 'Cofres cheios permitem empréstimos de itens mágicos, informações de espiões em múltiplas cidades e apoio logístico completo.'
      }
    ]
  },
  ...
  'guild-visitors': {
    ...
    description: 'A movimentação na sede reflete sua importância, reputação e recursos. Uma sede movimentada indica sucesso, enquanto uma vazia pode ter problemas sérios.',
    sections: [
      {
    ...
    examples: [
      {
        title: 'Sede Vazia',
        description: 'Rumores de incompetência ou corrupção afastaram todos. Apenas contratos desesperados ou de baixo valor estão disponíveis.'
      },
      {
        title: 'Sede Lotada',
        description: 'Aventureiros fazem fila do lado de fora. Múltiplas mesas atendem clientes simultaneamente. Rumores e oportunidades abundam.'
      }
    ]
  },
  ...
  'settlement-types': {
    title: 'Tipos de Assentamento',
    description: 'O tipo de assentamento determina fundamentalmente que tipo de sede da Guilda pode existir ali, desde pequenos escritórios até complexos majestosos.',
    sections: [
      {
    ...
    examples: [
      {
        ...
        description: 'Uma mesa no canto da taverna local, atendida pela filha do taverneiro nas manhãs. Conhece todos os problemas locais pessoalmente.'
      },
      {
        title: 'Complexo Metropolitano',
        description: 'Edifício de três andares com portais de teletransporte, biblioteca, salas de reunião e dormitórios para membros visitantes.'
      }
    ]
  }
}
