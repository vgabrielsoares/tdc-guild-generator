...
export const GOVERNMENT_RELATIONS_TABLE: TableEntry<string>[] = [
  {
    ...
    max: 2,
    result: "Péssima",
    description: "Relação péssima com o governo",
  },
  { min: 3, max: 4, result: "Ruim", description: "Relação ruim com o governo" },
  {
    min: 5,
    max: 8,
    result: "Ruim, mas tentam manter a cordialidade",
    description: "Relação ruim mas cordial",
  },
  {
    min: 9,
    max: 14,
    result: "Diplomática",
    description: "Relação diplomática",
  },
  {
    min: 15,
    max: 15,
    result: "Boa, mas o governo tenta miná-los secretamente",
    description: "Boa mas com tensão",
  },
  { min: 16, max: 17, result: "Boa", description: "Boa relação" },
  {
    min: 18,
    max: 20,
    result: "Muito boa, cooperam frequentemente",
    description: "Muito boa relação",
  },
  {
    min: 21,
    max: 50,
    result: "Excelente, governo e guilda são quase como um",
    description: "Excelente relação",
  },
];
...
export const POPULATION_RELATIONS_TABLE: TableEntry<string>[] = [
  {
    min: 1,
    max: 2,
    result: "Péssima, puro ódio",
    description: "Reputação péssima",
  },
  {
    min: 3,
    max: 8,
    result: "Ruim, vistos como mercenários",
    description: "Reputação ruim",
  },
  {
    min: 9,
    max: 12,
    result: "Ruim, só causam problemas",
    description: "Vistos negativamente",
  },
  {
    min: 13,
    max: 14,
    result: "Opinião dividida",
    description: "Opinião dividida",
  },
  {
    min: 15,
    max: 16,
    result: "Boa, ajudam com problemas",
    description: "Boa reputação",
  },
  {
    min: 17,
    max: 18,
    result: "Boa, nos mantêm seguros",
    description: "Vistos como protetores",
  },
  {
    min: 19,
    max: 20,
    result: "Muito boa, sem eles estaríamos perdidos",
    description: "Muito boa reputação",
  },
  {
    min: 21,
    max: 50,
    result: "Excelente, a guilda faz o assentamento funcionar",
    description: "Excelente reputação",
  },
];
...
export const RESOURCES_LEVEL_TABLE: TableEntry<string>[] = [
  // Extensão para valores negativos devido a modificadores
  {
    ...
    max: 0,
    result: "Em débito",
    description: "A guilda deve dinheiro",
  },
  {
    min: 1,
    max: 2,
  ...
  },
  {
    min: 9,
    max: 9,
    result: "Escassos e obtidos com muito esforço e honestidade",
    description: "Recursos honestos mas difíceis",
  },
  {
    min: 10,
    max: 12,
    result: "Limitados",
    description: "Recursos suficientes para sobreviver",
  },
  {
    min: 13,
    max: 15,
  ...
  },
  {
    ...
    max: 16,
    result: "Excedentes",
    description: "Recursos em abundância",
  },
  {
    min: 17,
    max: 17,
    result: "Excedentes mas alimenta fins malignos",
    description: "Recursos questionáveis",
  },
  {
    min: 18,
    max: 19,
    ...
    description: "Recursos governamentais",
  },
  {
    min: 20,
    max: 20,
    result: "Abundantes",
    description: "Recursos muito abundantes",
  },
  // Extensão para valores altos devido a modificadores (21+)
  {
    min: 21,
    max: 50,
    result: "Abundantes vindos de muitos anos de serviço",
    description: "Recursos de longa data",
  },
];
...
export const EMPLOYEES_TABLE: TableEntry<string>[] = [
  {
    min: 1,
    max: 1,
    result: "1 funcionário despreparado",
    description: "Funcionário incompetente",
  },
  {
    min: 2,
    max: 4,
    result: "1d4 funcionários despreparados para o trabalho",
    description: "Funcionários não qualificados",
  },
  {
    min: 5,
    max: 6,
    result: "1d4+2 funcionários despreparados para o trabalho",
    description: "Mais funcionários não qualificados",
  },
  {
    min: 7,
    max: 9,
    result: "1 funcionário experiente",
    description: "Funcionário competente",
  },
  {
    min: 10,
    max: 10,
    result: "1d4+1 membros do clero",
    description: "Clero capacitado",
  },
  {
    min: 11,
    max: 12,
    result: "1d4+1 ex-membros da guilda",
    description: "Ex-membros experientes",
  },
  {
    min: 13,
    max: 14,
    result: "1 nobre e seus serviçais",
    description: "Nobre com equipe",
  },
  {
    min: 15,
    max: 15,
    result: "1 aventureiro pagando dívidas",
    description: "Aventureiro devedor",
  },
  {
    min: 16,
    max: 18,
    result: "1 experiente explorador",
    description: "Explorador expert",
  },
  {
    min: 19,
    max: 19,
    result: "1 animal falante",
    description: "Animal especialista",
  },
  {
    min: 20,
    max: 20,
    result: "1d4 ex-aventureiros",
    description: "Ex-aventureiros especialistas",
  },
  {
    min: 21,
    max: 25,
    result: "1d6+3 funcionários experientes",
    description: "Equipe experiente",
  },
];
...
export function getDiceNotationString(
  settlementType: string,
  category: "structure" | "visitors"
): string {
  const diceNotation =
    SETTLEMENT_DICE[category][
      settlementType as keyof (typeof SETTLEMENT_DICE)[typeof category]
    ];
  if (!diceNotation) return "1d20";

  const modifierStr =
    diceNotation.modifier === 0
      ? ""
      : diceNotation.modifier > 0
